            ...
            <tbody>
              {users.map((user) => (
                <tr key={user._id} className="bg-gray-800 border-b border-gray-700 text-center">
                  ...
                  <td className="p-2">
                    <span
                      className="inline-block px-3 py-1 rounded-full text-sm bg-green-800 text-green-200 border border-green-600"
                    >
                      {user.role}
                    </span>
                  </td>
          ...
          {users.map((user) => (
            ...
            >
              <div className="flex justify-between items-center">
                ...
                <span
                  className="px-2 py-1 rounded-full text-xs bg-green-800 text-green-200 border border-green-600"
                >
                  {user.role}
                </span>
              </div>
