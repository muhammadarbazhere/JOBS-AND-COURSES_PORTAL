...
import Job from '../../../../Components/JobsInternships/Job';
...
function Jobs() {
  ...
  return (
    <div className='w-full h-full px-1 sm:px-4 md:px-10 lg:px-24 py-10 font-[Chivo] bg-blue-100'>
      <h1 className="text-center text-4xl  text-transparent bg-gradient-to-r from-cyan-500 to-blue-500 bg-clip-text font-bold">Job Table</h1>
