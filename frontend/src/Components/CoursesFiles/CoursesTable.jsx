...
function CoursesTable() {
  ...
  const fetchCourses = async () => {
    ...
    try {
      ...
      setCourses(data); // ✅ now includes all courses
    } catch (error) {
  ...
  return (
    <div className="font-[Chivo] bg-blue-100 py-10 px-6 sm:px-10 lg:px-16 min-h-screen">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 my-3">
